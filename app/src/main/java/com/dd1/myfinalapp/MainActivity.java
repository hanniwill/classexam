...
import com.dd1.editschedule.SetActivity;
...
import static com.dd1.myfinalapp.R.id.list0;
...
//			finish();
        ...
        list[0] = (ListView) findViewById(list0);
        ...
        for (int day = 0; day < 7; day++) {
            ...
            list[day].setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> arg0, View arg1,
                    ...
                    final int n = id;
                    final AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                    builder.setIcon(R.mipmap.bluebackground);
                    builder.setTitle("选择");
